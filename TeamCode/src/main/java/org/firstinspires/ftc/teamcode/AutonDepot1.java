...
@Disabled
public class AutonDepot1 extends LinearOpMode {
...
//        vuforia = ClassFactory.getInstance().createVuforia(parameters);
        vuforia = new CloseableVuforiaLocalizer(parameters); //This will work because ClassFactory.createVuforia() returns a VuforiaLocalizerImpl,
        // which we are doing except with a subclass of VuforiaLocalizerImpl
...
//        turnToBlock();
        ...
        robot.turnDegrees(startYaw - endYaw, 1);
